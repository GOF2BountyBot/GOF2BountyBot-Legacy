...
class BountyDefeatEventHandler(Protocol):
    def __call__(self, bounty: "bbBounty.Bounty", guild: "bbGuild.bbGuild") -> Awaitable[Any]: ...

class BountiesEventHub:
    def __init__(self) -> None:
        self.listeners: Set[BountyDefeatEventHandler] = set()

    def onBountyDefeated(self, bounty: "bbBounty.Bounty", guild: "bbGuild.bbGuild") -> asyncio.Task:
        return asyncio.create_task(asyncio.wait(l(bounty, guild) for l in self.listeners))
