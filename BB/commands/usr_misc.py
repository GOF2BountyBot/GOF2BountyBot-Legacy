...
from ..reactionMenus import ReactionMenu, ReactionPollMenu, PagedReactionMenu, DataPrivacyReactionMenu
...
async def cmd_how_to_play(message : discord.Message, args : str, isDM : bool):
    ...
    try:
        ...
        if not isDM:
            requestedBBGuild = bbGlobals.guildsDB.getOrAddGuildID(message.guild.id)
